...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_rg3xwcd', 'template_o1x99bo', form.current, 'os1F4Wa4kPhdKrsx_')
    e.target.reset()
  };
        ...
        <div className='contact__content' >
          ...
          <div className='contact__info'  >
            ...
            {/* <div className='contact__card' >
              ...
              <a href='jykhvhvkvvg' className='contact__button' > write me
                <i className='bx bx-right-arrow-alt contact__button-icon'  >
                </i >
              </a>
            </div> */}
            ...
            {/* <div className='contact__card' >
              ...
              <a href='vhghgn vb' className='contact__button' > write me
                <i className='bx bx-right-arrow-alt contact__button-icon'  >
                </i >
              </a>
            </div> */}
